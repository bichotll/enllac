...
use Bic\EnllacBundle\Entity\Tag;
use Bic\EnllacBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BicEnllacBundle:Tag')->findAll();
     ...
     * @Method("POST")
     * @Template("BicEnllacBundle:Tag:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BicEnllacBundle:Tag')->find($id);
     ...
     * @Method("PUT")
     * @Template("BicEnllacBundle:Tag:edit.html.twig")
     */
