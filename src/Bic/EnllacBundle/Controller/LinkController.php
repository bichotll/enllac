...
use Bic\EnllacBundle\Entity\Link;
use Bic\EnllacBundle\Form\LinkType;
...
class LinkController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BicEnllacBundle:Link')->findAll();
     ...
     * @Method("POST")
     * @Template("BicEnllacBundle:Link:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BicEnllacBundle:Link')->find($id);
     ...
     * @Method("PUT")
     * @Template("BicEnllacBundle:Link:edit.html.twig")
     */
